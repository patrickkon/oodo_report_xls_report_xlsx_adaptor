...
xf_dict = {
    ...
    'alignment': {
        ...
        'horz': {
            ...
            'filled': 'fill',
            'justified': 'justify',
            'center_across_selection': 'center_across',
            'centre_across_selection': 'center_across',
...
def _parse_strg_to_obj(wb, strg, obj, parse_dict,
    field_sep=",", line_sep=";", intro_sep=":", esc_char="\\", debug=False):
    xlsx_cell_format = wb.add_format()
    for line in _esplit(strg, line_sep, esc_char):
        ...
        for kv_str in _esplit(item_str, field_sep, esc_char):
            ...
            xlsx_cell_format.get_xlsx_cell_format_style_func(section, k, value)
    return xlsx_cell_format

def easyxf(wb, strg_to_parse="", num_format_str=None,
           field_sep=",", line_sep=";", intro_sep=":", esc_char="\\", debug=False):
    """
    ...
    if strg_to_parse:
        xlsx_cell_format = _parse_strg_to_obj(wb, strg_to_parse, xfobj, xf_dict,
